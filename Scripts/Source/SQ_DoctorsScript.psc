...
Group Autofill
	...
	; SFCP Fix https://www.starfieldpatch.dev/issues/982
	; Give the script access to the Environmental Damage actor value, to restore it to 0 down below.
...
Function HealWounds()
	...
	; SFCP Fix https://www.starfieldpatch.dev/issues/982
	; Heal environmental damage before we heal health.
	PlayerRef.RestoreValue(EnvDmg, iHealMax)
	; End fix
