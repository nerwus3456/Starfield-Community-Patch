...
; SFCP Fix https://www.starfieldpatch.dev/issues/975
; Disable all the Disciples that were previously enabled, so their corpses do not persist in the world forever (and eventually get revived) after this quest.
Alias_Disciples_Hangout01.DisableAll()
Alias_Disciples_Hangout02.DisableAll()
Alias_Disciples_Hangout03.DisableAll()
Alias_Disciples_Warehouse.DisableAll()
Alias_Disciple01Leader.GetRef().Disable()
Alias_HoltHenley.GetRef().Disable()
; End Fix
